...
from napari_practical.segmentation import RFWidget
from napari_practical.watershed import WatershedWidget
from napari_practical.spot_finding import SpotFinderWidget
